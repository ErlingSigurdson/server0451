...
Перечень валидных команд закрытый.

По получении сообщения (пакета TCP), формат и содержание которого соответствуют требованиям сервера, он:
- по запросу клиента-подписчика направляет ему размещённую в топике команду, либо
- по указанию клиента меняет размещённую в топике команду.
