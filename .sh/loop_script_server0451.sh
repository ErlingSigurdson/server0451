...
PORT_1=$(grep -E -o "PORT_1=[0-9]+" "$PORT_CONFIG_FILE_PATH" | grep -E -o "[0-9]+" "$PORT_CONFIG_FILE_PATH")
PORT_2=$(grep -E -o "PORT_2=[0-9]+" "$PORT_CONFIG_FILE_PATH" | grep -E -o "[0-9]+" "$PORT_CONFIG_FILE_PATH")
